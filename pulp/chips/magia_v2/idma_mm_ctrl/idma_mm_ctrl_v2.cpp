 ...
 *
 * io_v2 port of idma_mm_ctrl.cpp. The register file, the FSMs and the
 * offload sequences are untouched; only the memory-mapped slave port moves to
 * the v2 IO protocol (vp/itf/io_v2.hpp):

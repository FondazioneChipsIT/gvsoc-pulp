...
class iDMA_mm_ctrl(gvsoc.systree.Component):
    """io_v2 sibling of :class:`idma_mm_ctrl.iDMA_mm_ctrl`.

    Same register file / FSMs / offload sequences towards the two iDMAs; the
    memory-mapped input port speaks io_v2 and answers inline, hence the
    IoV2Sync signature.
    """
    ...
    def __init__(self,
        ...
        self.add_sources(['pulp/chips/magia_v2/idma_mm_ctrl/idma_mm_ctrl_v2.cpp'])

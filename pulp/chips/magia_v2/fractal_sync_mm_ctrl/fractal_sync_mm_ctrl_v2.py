...
class FSync_mm_ctrl(gvsoc.systree.Component):
    """io_v2 sibling of :class:`fractal_sync_mm_ctrl.FSync_mm_ctrl`.

    Same fractal-sync XIF behaviour; the memory-mapped input port speaks
    io_v2 and answers inline, hence the IoV2Sync signature.
    """
    ...
    def __init__(self,
        ...
        self.add_sources(['pulp/chips/magia_v2/fractal_sync_mm_ctrl/fractal_sync_mm_ctrl_v2.cpp'])

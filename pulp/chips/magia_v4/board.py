...
import gvsoc.runner
import os
from pulp.chips.magia_v4.arch import MagiaTree, MagiaArch

from pulp.chips.magia_v4.soc import MagiaV4Soc
from gvrun.parameter import TargetParameter

class MagiaV4Board(gvsoc.systree.Component):
    def __init__(self, parent, name:str, parser, options):
        ...
        # Soc model
        tree = MagiaTree(self, 'magia_v4')
        self.soc = MagiaV4Soc(self, 'magia-v4-soc', tree, parser, binary)
...
class Target(gvsoc.runner.Target):
    def __init__(self, parser, options):
        super(Target, self).__init__(parser, options,
              model=MagiaV4Board, description="Magia v4 (memory mapped with pulp cluster) board")
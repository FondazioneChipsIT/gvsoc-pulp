...
from pulp.chips.magia_v4.tile import MagiaV4Tile
...
from pulp.chips.magia_v4.fractal_sync.fractal_sync import *
from pulp.chips.magia_v4.kill_module.kill_module import *
...
class MagiaV4Soc(gvsoc.systree.Component):
    def __init__(self, parent, name, tree, parser, binary=None):
        ...
        # Create Tiles
        cluster:List[MagiaV4Tile] = []
        for id in range(0,tree.nb_clusters):
            cluster.append(MagiaV4Tile(self, f'magia-tile-{id}', tree, parser, id))
